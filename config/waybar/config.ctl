0|30|top|( idle_inhibitor clock ) ( cpu memory ) ( mpris )|( niri/workspaces niri/window ) ( hyprland/language )|( backlight network bluetooth pulseaudio pulseaudio#microphone custom/updates ) ( tray battery ) ( custom/wallchange custom/mode custom/wbar custom/cliphist custom/power ) 
